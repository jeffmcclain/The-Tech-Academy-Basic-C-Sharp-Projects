...
namespace Branching
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // use a ternary operator (this uses three arguments)
            ...
            //else
            //{
            //    Console.WriteLine("Uhhhhh.....yada yada yada.");
            //}
            ...
            // this is a ternary operator (an operator that takes three arguments)
